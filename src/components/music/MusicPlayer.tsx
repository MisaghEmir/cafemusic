...
const MusicPlayer = () => {
  ...
  return (
    <div
      className={`flex flex-col items-center gap-2 ${music === null && "hidden"}`}
    >
      <div className=" relative rounded-xl overflow-hidden">
        <img
          src={music?.image}
          className="w-[7.5rem] aspect-4/4 rounded-xl object-cover image-shadow"
          alt=""
        />
      ...
      <div>
        <b className="text-sm font-bold">
          set fire to the rain - <span className="text-white/60">Adele</span>
        </b>
      </div>
